...
import time
import textract
driver = webdriver.PhantomJS(executable_path="/Users/danilogiovannico/Desktop/PROGETTO\ DATABASE/CitLAB/RestBE/api/paper_api/ncbi/phantomjs/bin/phantomjs")
    ...
    for link_pdf in a_links_pdf:
        if "PDF" in link_pdf.text:
            ...
            try:
                ...
                profile = {
                    "download.default_directory": MEDIA_URL+"pdf",
                    "plugins.always_open_pdf_externally": True
                }
                options.add_experimental_option("prefs", profile)
                driver_pdf = webdriver.Chrome(
                    '/Users/danilogiovannico/Desktop/PROGETTO\ DATABASE/CitLAB/RestBE/api/paper_api/ncbi/chrome_driver/chromedriver',
